...
import { Loader2, RefreshCw, AlertTriangle, CheckCircle, ArrowUpDown, TrendingUp, TrendingDown, Newspaper } from 'lucide-react'
...
export default function RebalancePage() {
  ...
  const [activeTab, setActiveTab] = useState<'trades' | 'news' | 'impacts'>('trades')
